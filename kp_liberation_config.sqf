...
29 = SFP (Desert)
30 = LDF (Contact DLC) */
KP_liberation_preset_blufor = 22;
...
GRLIB_blufor_cap = 50;                                                 // Cap for BLUFOR.
GRLIB_sector_cap = 90;                                                 // Cap for sector defenders.
GRLIB_battlegroup_cap = 75;                                            // Cap for enemy battlegroups.
GRLIB_patrol_cap = 75;                                                 // Cap for enemy patrols.
